...
//realizar a solicitacao
	...
	//
	//colocando o @REPOSITORY para dizer q o CATEGORYREPOSITORY
	//é uma DEPEDENCIA injetavel... e INJETAMOS ELA no CATEGORYSERVICE
	//com o @REPOSITORY os OBJ de CATEGORYREPOSITORY passam a ser
